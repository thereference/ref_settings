 ...
 *
 * @see \Drupal\ref_settings\Entity\Settings
...
class SettingsAccessControlHandler extends EntityAccessControlHandler {
  ...
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account) {
    switch ($operation) {
      ...
      case 'update':
        return AccessResult::allowedIfHasPermissions($account, ["edit settings in {$entity->bundle()}", 'administer settings'], 'OR');

      case 'delete':
        return AccessResult::allowedIfHasPermissions($account, ["delete settings in {$entity->bundle()}", 'administer settings'], 'OR');
